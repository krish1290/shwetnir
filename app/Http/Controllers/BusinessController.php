    ...
    public function postBusinessSettings(Request $request)
    {
      // dd($request->all());
        ...
        try {
            ...
            //upload logo
            $logo_login_name = $this->businessUtil->uploadFile($request, 'login_logo', 'login_logos', 'image');
            if (!empty($logo_login_name)) {
                $business_details['login_logo'] = $logo_login_name;
            }
            ...
            //Update business settings
            if (!empty($business_details['login_logo'])) {
                $business->login_logo = $business_details['login_logo'];
            } else {
                unset($business_details['login_logo']);
            }
