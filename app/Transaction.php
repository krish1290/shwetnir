...
class Transaction extends Model
{
    ...
    public function wastage_type()
    {
        return $this->belongsTo(\App\WastageType::class, 'adjustment_type');
    }
    ...
    public static function getApprovedStatus($transaction)
    {
        $payment_status = $transaction->is_approved;

        if (in_array($payment_status, ['0', '1'])) {
                $payment_status = $payment_status == '0' ? 'Unapproved' : 'Approved';
            }
