                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('printer.printers') }}">@lang('printer.printers')</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page"><span>@lang('printer.manage_your_printers')</span></li>
                            </ol>
