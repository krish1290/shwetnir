@component('components.widget', [
    'class' => 'box-solid  ',
    'id' => 'recur_expense_div',
])
    <div class="row ">
        <div class="col-md-4 col-sm-6">
            <br>
            <label>
                {!! Form::checkbox('is_recurring', 1, !empty($expense->is_recurring) == 1, [
                    'class' => 'input-icheck',
                    'id' => 'is_recurring',
        ...
        <div class="col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::number('recur_interval', !empty($expense->recur_interval) ? $expense->recur_interval : null, [
                        'class' => 'form-control',
                        'style' => 'width: 50%;',
                    ]) !!}
                    ...
                    {!! Form::select(
                        ...
                        !empty($expense->recur_interval_type) ? $expense->recur_interval_type : 'days',
                        ['class' => 'form-control', 'style' => 'width: 50%;', 'id' => 'recur_interval_type'],
                    ) !!}
        ...
        <div class="col-md-4 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::number('recur_repetitions', !empty($expense->recur_repetitions) ? $expense->recur_repetitions : null, [
                    'class' => 'form-control',
                ]) !!}
        ...
        <div
            ...
            <div class="form-group">
                ...
                {!! Form::select(
                    ...
                    $repetitions,
                    !empty($expense->subscription_repeat_on) ? $expense->subscription_repeat_on : null,
