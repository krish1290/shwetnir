                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>@lang('role.edit_role')</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        'permissions[]',
                                        'purchase.duplicate',
                                        in_array('purchase.duplicate', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                                    {{ __('lang_v1.duplicate') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        'permissions[]',
                                        'purchase.approve',
                                        in_array('purchase.approve', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                                    {{ __('lang_v1.approve') }}
                                </label>
                ...
                <div class="col-md-9">
                    @if (in_array('add_sale', $enabled_modules))
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'direct_sell.duplicate', in_array('direct_sell.duplicate', $role_permissions), [
                                        'class' => 'input-icheck',
                                    ]) !!} {{ __('lang_v1.duplicate_sell') }}
                                </label>
                            </div>
                        </div>
                    @endif
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio('radio_option[duplicate_view]', 'duplicate.view_all', in_array('duplicate.view_all', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.view_all_duplicates') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio('radio_option[duplicate_view]', 'duplicate.view_own', in_array('duplicate.view_own', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.view_own_duplicates') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'duplicate.update', in_array('duplicate.update', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.edit_duplicate') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'duplicate.delete', in_array('duplicate.delete', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.delete_duplicate') }}
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('training.view_training', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('View Training') }}
                            </label>
                        </div>
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('training.create_training', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                                {{ __('Edit Training') }}
                            </label>
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('training.delete_training', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                                {{ __('Delete Training') }}
                            </label>
