        ...
        <div class="row">
            <div class="col-md-12 form_col" style="display: none;">
                @component('components.widget')
                    {!! Form::open([
                        'url' => action([\App\Http\Controllers\Install\ModulesController::class, 'uploadModule']),
                    ...
                    <table class="table">
                        ...
                        @foreach ($modules as $module)
                            <tr>
                                ...
                                disabled
                            @else
                                href="{{ $module['install_link'] }}" @endif>
                                    ...
                                    title="@lang('lang_v1.disabled_in_demo')"
                                @else
                                    href="{{ $module['uninstall_link'] }}" @endif
                                            onclick="return confirm('Do you really want to uninstall the module? Module will be uninstall but the data will not be deleted')">@lang('lang_v1.uninstall')
                                        </a>
                            ...
                            --}}
                                    ...
                                    <form
                                        ...
                                        <button class="btn btn-danger btn-xs"
                                            @if ($is_demo) disabled="disabled"
                                    title="@lang('lang_v1.disabled_in_demo')" @endif>
                                ...
                                <td>
                                    ...
                                    @isset($module['version'])
                                        <small class="label bg-gray">@lang('lang_v1.version')
                                            {{ $module['version']['installed_version'] }}</small>
                                    @endisset
