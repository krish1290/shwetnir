...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('lang_v1.add_purchase_order') <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body"
    ...
    <section class="content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\PurchaseOrderController::class, 'store']),
            'method' => 'post',
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('purchase_requisition_ids[]', [], null, [
                                'class' => 'form-control select2',
                                'multiple',
                                'id' => 'purchase_requisition_ids',
                            ]) !!}
                        </div>
                    </div>
                </div>
