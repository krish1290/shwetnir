...
@section('content')
                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">@lang('barcode.add_barcode_setting')</a></li>
                            </ol>
                        </nav>
                    </div>
                </li>
    ...
    <section class="content">
        {!! Form::open([
            'url' => action([\App\Http\Controllers\BarcodeController::class, 'store']),
            'method' => 'post',
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::number('stickers_in_one_row', null, [
                                    'class' => 'form-control',
                    ...
                    <div class="col-sm-6 stickers_per_sheet_div">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::number('stickers_in_one_sheet', null, [
                                    'class' => 'form-control',
