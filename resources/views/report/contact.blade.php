                ...
                <table class="table table-bordered table-striped" id="supplier_report_tbl">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('report.total_payment_to_vendor')</th>
                            <th>@lang('report.total_sell')</th>
                            <th>@lang('lang_v1.total_sell_return')</th>
                            <th>@lang('report.total_payment_from_customer')</th>
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 footer-total text-center">
                            ...
                            <td><span class="display_currency" id="footer_total_payment_to_vendor" data-currency_symbol ="true"></span></td>
                            ...
                            <td><span class="display_currency" id="footer_total_payment_from_customer" data-currency_symbol ="true"></span></td>
