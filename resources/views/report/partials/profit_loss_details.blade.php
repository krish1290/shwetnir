<div class="col-xs-6">
    @component('components.widget')
        <table class="table table-striped">
            ...
            <tr>
                <th>{{ __('home.total_purchase') }} @lang('product.tax') & @lang('sale.discount'):</th>
                <td>
                    <span class="display_currency" data-currency_symbol="true">{{$data['total_purchase_tax']}}</span>
                </td>
            </tr>
            <tr>
...
<div class="col-xs-6">
    @component('components.widget')
        <table class="table table-striped">
            ...
            <tr>
                <th>{{ __('home.total_sell') }} @lang('product.tax') & @lang('sale.discount'):</th>
                <td>
