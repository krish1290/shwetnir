                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>@lang('lang_v1.import_sales')</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.widget')
                    {!! Form::open([
                        'url' => action([\App\Http\Controllers\ImportSalesController::class, 'preview']),
                        'method' => 'post',
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <a href="{{ asset('files/import_sales_template.xlsx') }}" class="btn btn-success" download><i
                        ...
                        <tbody>
                            @foreach ($imported_sales_array as $key => $value)
                                <tr>
                                    ...
                                    @can('sell.delete')
                                        <td><a href="{{ action([\App\Http\Controllers\ImportSalesController::class, 'revertSaleImport'], $key) }}"
