<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action(
                [\App\Http\Controllers\AccountController::class, 'updateAccountTransaction'],
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">
                @if ($account_transaction->sub_type == 'opening_balance')
                    @lang('lang_v1.edit_opening_balance')
                @elseif($account_transaction->sub_type == 'fund_transfer')
                    @lang('lang_v1.edit_fund_transfer')
                @elseif($account_transaction->sub_type == 'deposit')
                    @lang('lang_v1.edit_deposit')
                @endif
            </h4>
        </div>
        ...
        <div class="modal-body">
            ...
            @if ($account_transaction->sub_type == 'deposit')
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('account_id', $accounts, $account_transaction->account_id, [
                        'class' => 'form-control',
            ...
            @if ($account_transaction->sub_type == 'deposit')
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('from_account', $accounts, $account_transaction->transfer_transaction->account_id ?? null, [
                        'class' => 'form-control',
                        'placeholder' => __('messages.please_select'),
                    ]) !!}
                </div>
            ...
            @if ($account_transaction->sub_type == 'fund_transfer')
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('to_account', $accounts, $account_transaction->transfer_transaction->account_id ?? null, [
                        'class' => 'form-control',
                        'required',
                    ]) !!}
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                    {!! Form::text('operation_date', @format_datetime($account_transaction->operation_date), [
                        'class' => 'form-control',
                        'required',
