...
@section('content')
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>{{ $title }} <small>(
                                            @if ($transaction->type == 'sales_order')
                                                @lang('restaurant.order_no')
                                            @else
                                                @lang('sale.invoice_no')
                                            @endif: <span
                                                class="text-success">#{{ $transaction->invoice_no }})</span>
                                        </small></span>
                                </li>
                            </ol>
                        </nav>
    ...
    <section class="content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\SellPosController::class, 'saveDuplicate'], [$transaction->id]),
            'method' => 'post',
            'id' => 'edit_sell_form',
            'files' => true,
        ]) !!}
        ...
        <input type="hidden" name="sale_order_type" value="type">
        @if ($transaction->type == 'sales_order')
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <button type="button" class="btn btn-primary btn-big" id="submit-sell">@lang('messages.save')</button>
