...
@section('content')
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>@lang('lang_v1.shipments')</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
    ...
    <section class="content no-print">
        ...
        @endphp
        @component('components.widget', ['class' => 'box-primary date-table-container'])
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',
                '#sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #created_by, #shipping_status, #service_staffs',
                function() {
                    sell_table.ajax.reload();
                });
        });
