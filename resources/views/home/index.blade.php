...
@section('content')
                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">@lang('home.home')</a></li>
                            </ol>
                        </nav>
                    </div>
                </li>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="container p-0">
                        <div class=" layout-top-spacing date-table-container">
                            ...
                            @if (auth()->user()->can('dashboard.data'))
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                                            <div class="info-box info-box-new-style">
                                                ...
                                                <p class="mb-0 text-muted fs-10 mt-5">
                                                    {{ __('lang_v1.total_sell_return') }}: <span
                                                        class="total_sr"></span><br>
                                                    {{ __('lang_v1.total_sell_return_paid') }}<span
                                        ...
                                        @if (session('business.enable_product_expiry') == 1)
                                            <div class="col-sm-6">
                                                @component('components.widget', ['class' => 'box-warning'])
                                                    ...
                                                    @endslot
                                                    @slot('title')
                                                        {{ __('home.stock_expiry_alert') }} @show_tooltip(
                                                        __('tooltip.stock_expiry_alert', [ 'days'
                                ...
                                @if (auth()->user()->can('so.view_all') ||
                                    ...
                                    <div class="row"
                                        @if (!auth()->user()->can('dashboard.data')) style="margin-top: 190px !important;" @endif>
                                        <div class="col-sm-12">
                                            @component('components.widget', ['class' => 'box-warning'])
                                                @slot('icon')
                                        ...
                                        @component('components.filters', ['title' => __('report.filters'), 'class' => 'box-solid'])
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::select('leave_type_filter', $leave_types, null, [
                                                        'class' => 'form-control select2',
                                                        'style' => 'width:100%',
                                                        'placeholder' => __('lang_v1.all'),
                                                    ]) !!}
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('leave_filter_date_range', null, [
    ...
    <!-- /.content -->
    <div class="modal fade" id="add_leave_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel"></div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        function get_leave_summary() {
            ...
            $.ajax({
                url: '{{ action([\Modules\Essentials\Http\Controllers\EssentialsLeaveController::class, 'getUserLeaveSummary']) }}?user_id=' +
