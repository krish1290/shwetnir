<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('login_logo', __('business.upload_login_logo') . ':') !!}
                    {!! Form::file('login_logo', ['accept' => 'image/*', 'id' => 'login_logo_input']); !!}
                    <p class="help-block"><i> @lang('business.logo_login_help')</i></p>
            </div>
        </div>
    </div>
     {{-- code --}}
...
<script>
    function checkFileSize() {
        var input = document.getElementById('login_logo_input');
    ...
    // Attach the checkFileSize function to the onchange event of the file input
    document.getElementById('login_logo_input').onchange = checkFileSize;
</script>
