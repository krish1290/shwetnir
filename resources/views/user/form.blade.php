...
<div class="row">
    <div class="form-group col-md-3">
        ...
        {!! Form::date('dob', !empty($user->dob) ? date('Y-m-d',strtotime($user->dob)) : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::select(
            ...
            ['class' => 'form-control', 'id' => 'gender', 'placeholder' => __('messages.please_select')],
        ) !!}
    </div>
    <div class="form-group col-md-3">
        ...
        {!! Form::select(
            ...
            ['class' => 'form-control', 'placeholder' => __('lang_v1.marital_status')],
        ) !!}
    </div>
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text('contact_number', !empty($user->contact_number) ? $user->contact_number : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text('fb_link', !empty($user->fb_link) ? $user->fb_link : null, [
            'class' => 'form-control',
            'placeholder' => __('lang_v1.fb_link'),
        ]) !!}
    </div>
    <div class="form-group col-md-3">
        {!! Form::label('twitter_link', __('lang_v1.twitter_link') . ':') !!}
        {!! Form::text('twitter_link', !empty($user->twitter_link) ? $user->twitter_link : null, [
            'class' => 'form-control',
            'placeholder' => __('lang_v1.twitter_link'),
        ]) !!}
    </div>
    <div class="form-group col-md-3">
        {!! Form::label('social_media_1', __('lang_v1.linked_link') . ':') !!}
        {!! Form::text('social_media_1', !empty($user->social_media_1) ? $user->social_media_1 : null, [
            'class' => 'form-control',
            'placeholder' => __('lang_v1.linked_link'),
        ]) !!}
    </div>
    <div class="clearfix"></div>
    <div class="form-group col-md-3">
        {!! Form::label('social_media_2', __('lang_v1.social_media', ['number' => 2]) . ':') !!}
        {!! Form::text('social_media_2', !empty($user->social_media_2) ? $user->social_media_2 : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text('custom_field_1', !empty($user->custom_field_1) ? $user->custom_field_1 : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text('custom_field_2', !empty($user->custom_field_2) ? $user->custom_field_2 : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text('custom_field_3', !empty($user->custom_field_3) ? $user->custom_field_3 : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text('custom_field_4', !empty($user->custom_field_4) ? $user->custom_field_4 : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text('guardian_name', !empty($user->guardian_name) ? $user->guardian_name : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text('id_proof_name', !empty($user->id_proof_name) ? $user->id_proof_name : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-6">
        ...
        {!! Form::textarea('permanent_address', !empty($user->permanent_address) ? $user->permanent_address : null, [
            'class' => 'form-control',
    ...
    <div class="form-group col-md-6">
        ...
        {!! Form::textarea('current_address', !empty($user->current_address) ? $user->current_address : null, [
            'class' => 'form-control',
            'placeholder' => __('lang_v1.current_address'),
            'rows' => 3,
        ]) !!}
        <input type="checkbox" name='copy_address' id='copy_address'> Same as permanent address
    </div>
    <div class="col-md-12">
        <hr>
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text(
            ...
            ['class' => 'form-control', 'id' => 'account_holder_name', 'placeholder' => __('lang_v1.account_holder_name')],
        ) !!}
    </div>
    <div class="form-group col-md-3">
        ...
        {!! Form::text(
            ...
            ['class' => 'form-control', 'id' => 'account_number', 'placeholder' => __('lang_v1.account_number')],
        ) !!}
    </div>
    <div class="form-group col-md-3">
        ...
        {!! Form::text(
            ...
            ['class' => 'form-control', 'id' => 'bank_name', 'placeholder' => __('lang_v1.bank_name')],
        ) !!}
    </div>
    <div class="form-group col-md-3">
        ...
        {!! Form::text(
            ...
            !empty($bank_details['bank_code']) ? $bank_details['bank_code'] : null,
            ['class' => 'form-control', 'id' => 'bank_code', 'placeholder' => __('lang_v1.bank_code')],
        ) !!}
    </div>
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::text(
            ...
            !empty($bank_details['tax_payer_id']) ? $bank_details['tax_payer_id'] : null,
            ['class' => 'form-control', 'id' => 'tax_payer_id', 'placeholder' => __('lang_v1.tax_payer_id')],
        ) !!}
    </div>
</div>
...
$('#test_dob').attr('max', formattedDate);
        });
    </script>
@endpush
