@extends('layouts.app')
@section('title', __('purchase.duplicate'))
...
@section('content')
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>@lang('purchase.duplicate')</span></li>
                            </ol>
    ...
    <section class="content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\PurchaseController::class, 'saveDuplicatePurchase']),
            'method' => 'POST',
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="location_id" value="{{$purchase->location_id}}">
                    </div>
                </div>
