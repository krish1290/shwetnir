                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('purchases') }}">@lang('purchase.purchases')</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>@lang('purchase.edit_purchase')</span></li>
                            </ol>
    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('purchase_approve_status', __('purchase.purchase_approve_status') . ':*') !!} @show_tooltip(__('tooltip.purchase_approve_status'))
                        <select class="form-control" name="is_approved" required>
                          <option value="">Select Approval Status</option>
                          <option value="1"{{$purchase->is_approved == '1'?'selected':''}}>Approved</option>
                          <option value="0"{{$purchase->is_approved == '0'?'selected':''}}>Pending</option>
                        </select>
                    </div>
                </div>
                @endif
