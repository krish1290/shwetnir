...
<section class="content no-print">
	...
	@endphp
	{!! Form::open(['url' => action([\App\Http\Controllers\SellPosController::class, 'saveDuplicate'], [$transaction->id]), 'method' => 'post', 'id' => 'duplicate_pos_sell_form' ]) !!}
	<!-- {{ method_field('PUT') }} -->
	<div class="row mb-12">
		<div class="col-md-12">
			<div class="row">
					...
					<div class="box box-solid mb-12 @if(!isMobile()) mb-40 @endif">
						<div class="box-body pb-0">
							...
							<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
								@include('sale_pos.partials.pos_form_duplicate')
	...
	@include('sale_pos.partials.pos_form_actions', ['duplicate' => true])
	{!! Form::close() !!}
</section>
