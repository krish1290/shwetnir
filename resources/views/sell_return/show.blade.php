<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.sell_return') (<b>@lang('sale.invoice_no'):</b> {{ $sell->return_parent_sell->invoice_no }})
    </h4>
</div>
<div class="modal-body">
   <div class="row">
      <div class="col-sm-6 col-xs-6">
        ...
        <strong>@lang('lang_v1.return_date'):</strong> {{@format_date($sell->return_parent_sell->transaction_date)}}<br>
    ...
    <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
      <table class="table">
        ...
        <tr>
          ...
          <td><b>(-)</b></td>
          <td class="text-right">@if($sell->return_parent_sell->discount_type == 'percentage')
              @<strong><small>{{$sell->return_parent_sell->discount_amount}}%</small></strong> -
              @endif
...
<div class="modal-footer">
    <a href="#" class="print-invoice btn btn-primary" data-href="{{action([\App\Http\Controllers\SellReturnController::class, 'printInvoice'], [$sell->return_parent_sell->id])}}"><i class="fa fa-print" aria-hidden="true"></i> @lang("messages.print")</a>
