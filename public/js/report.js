$(document).ready(function () {
    ...
    supplier_report_tbl = $('#supplier_report_tbl').DataTable({
        ...
        fnDrawCallback: function (oSettings) {
            ...
            var total_payment_to_vendor = sum_table_col($('#supplier_report_tbl'), 'total_payment_to_vendor');
            $('#footer_total_payment_to_vendor').text(total_payment_to_vendor);
            
            var total_payment_from_customer = sum_table_col($('#supplier_report_tbl'), 'total_payment_from_customer');
            $('#footer_total_payment_from_customer').text(total_payment_from_customer);
    ...
    purchase_payment_report = $('table#purchase_payment_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'method', name: 'method' },
            { data: 'payment_from_vendor', name: 'payment_from_vendor' },
            { data: 'ref_no', name: 't.ref_no' },
            { data: 'action', orderable: false, searchable: false },
        ],
        fnDrawCallback: function (oSettings) {
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'method', name: 'method' },
            { data: 'payment_to_customer', name: 'payment_to_customer' },
            { data: 'invoice_no', name: 't.invoice_no' },
            { data: 'action', orderable: false, searchable: false },
        ],
        fnDrawCallback: function (oSettings) {
...
function updateStockAdjustmentReport() {
    ...
    stock_adjustment_table.ajax
        .url(
            '/wastage-management?location_id=' +
            location_id +
            '&start_date=' +
            start +
            '&end_date=' +
