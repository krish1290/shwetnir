...
Route::get('passwords/reset/{token}', [App\Http\Controllers\Auth\ResetPasswordController::class, 'showResetForm']);
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/purchases/update-approve-status', [PurchaseController::class, 'updateApproveStatus']);
    ...
    Route::get('purchase/duplicate/{id}', [PurchaseController::class, 'duplicatePurchase']);
    Route::post('purchase/save-duplicate', [PurchaseController::class, 'saveDuplicatePurchase']);
    ...
    Route::get('pos/duplicate-sale/{id}', [SellPosController::class, 'duplicateSale']);
    Route::post('pos/duplicate-sale/{id}', [SellPosController::class, 'saveDuplicate']);

    Route::resource('roles', RoleController::class);

    Route::resource('users', ManageUserController::class);
    Route::get('user/docList/{id}', [ManageUserController::class,'docList']);
    Route::post('user/addDoc', [ManageUserController::class,'addDoc']);
    Route::get('user/docDestroy/{id}', [ManageUserController::class,'docDestroy']);
    Route::get('user/download/image', [ManageUserController::class,'downloadImage']);
    ...
    Route::get('/reports/get-claim-reimbursement-report', [ReportController::class, 'claimReimbursementReport']);
    Route::get('/reports/claim-reimbursement-details', [ReportController::class, 'getClaimReimburseMentDetails']);
    ...
    Route::get('/wastage-management/remove-expired-stock/{purchase_line_id}', [WastageController::class, 'removeExpiredStock']);
    Route::post('/wastage-management/get_product_row', [WastageController::class, 'getProductRow']);
    Route::resource('wastage-management', WastageController::class);
    ...
    Route::post('sell-return/get_product_row', [CombinedPurchaseReturnController::class, 'getProductRow']);
    ...
    Route::post('/get_customer_sell', [SellReturnController::class, 'getSellByCustomer']);
    Route::post('/get_selled_product', [SellReturnController::class, 'getSelledProduct']);
    Route::post('/savereturn', [SellReturnController::class, 'savereturn']);
    ...
    Route::post('/purchase-return/get_product_row', [PurchaseReturnController::class, 'getProductRow']);
    Route::post('/purchase-return/get_supplier_purchase', [CombinedPurchaseReturnController::class, 'getSupplierPurchase']);
    Route::post('/get_purchased_product', [CombinedPurchaseReturnController::class, 'getPurchasedProduct']);
    ...
    Route::post('purchase-return/savereturn', [PurchaseReturnController::class, 'savereturn']);
    ...
    Route::post('upload-module', [ModulesController::class, 'uploadModule']);
    Route::delete('manage-modules/destroy/{module_name}', [ModulesController::class, 'destroy']);
    Route::resource('manage-modules', ModulesController::class)
        ->only(['index', 'update']);
