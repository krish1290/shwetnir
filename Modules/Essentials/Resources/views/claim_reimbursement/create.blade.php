<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\Modules\Essentials\Http\Controllers\ClaimReimbursementController::class, 'store']),
            'method' => 'post',
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('essentials::lang.add_claim_reimbursementt')</h4>
        </div>
            ...
            <div class="row">
                ...
                @if (auth()->user()->can('essentials.approve_claim_reimbursement') ||
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::select('employees[]', $users, null, ['class' => 'form-control select2', 'multipler']) !!}
                    </div>
                @else
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="input-group data">
                        {!! Form::text('applicable_date', null, [
                            'class' => 'form-control',
                ...
                @if (auth()->user()->can('essentials.approve_claim_reimbursement') ||
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::select('is_approved', [null => 'Select', '1' => __('Yes'), '2' => __('No')], null, [
                            'class' => 'form-control',
                        ]) !!}
                    </div>
                @endif
