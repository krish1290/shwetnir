...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            'url' => action([\Modules\Essentials\Http\Controllers\PayrollController::class, 'update'], [$payroll->id]),
            'method' => 'put',
            'id' => 'add_payroll_form',
        ]) !!}
        <div class="row">
                ...
                @component('components.widget')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('essentials_duration_unit', $payroll->essentials_duration_unit, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text(
                                ...
                                @num_format($payroll->essentials_amount_per_unit_duration),
                                [
                                    'class' => 'form-control input_number',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text(
                                'total',
                                @num_format($payroll->essentials_duration * $payroll->essentials_amount_per_unit_duration),
                                ['class' => 'form-control input_number', 'placeholder' => __('sale.total')],
                            ) !!}
                        </div>
                    </div>
                @endcomponent
                    ...
                    <table class="table table-condenced" id="allowance_table">
                        ...
                        <tbody>
                            ...
                            @forelse($allowances['allowance_names'] as $key => $value)
                                @include('essentials::payroll.edit_allowance_and_deduction_row', [
                                    ...
                                    'amount_type' => !empty($allowances['allowance_types'][$key])
                                        ? $allowances['allowance_types'][$key]
                                        : 'fixed',
                                    'percent' => !empty($allowances['allowance_percents'][$key])
                                        ? $allowances['allowance_percents'][$key]
                                        : 0,
                                ])
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><span id="total_allowances" class="display_currency"
                                        data-currency_symbol="true">{{ $total_allowances }}</span></td>
                                <td>&nbsp;</td>
                            </tr>
                        </tfoot>
                    </table>
                ...
                @component('components.widget')
                    ...
                    <table class="table table-condenced" id="deductions_table">
                        ...
                        <tbody>
                            ...
                            @forelse($deductions['deduction_names'] as $key => $value)
                                @include('essentials::payroll.edit_allowance_and_deduction_row', [
                                    ...
                                    'amount_type' => !empty($deductions['deduction_types'][$key])
                                        ? $deductions['deduction_types'][$key]
                                        : 'fixed',
                                    'percent' => !empty($deductions['deduction_percents'][$key])
                                        ? $deductions['deduction_percents'][$key]
                                        : 0,
                                ])
                        ...
                        <tfoot>
                            <tr>
                                <th colspan="2">@lang('sale.total')</th>
                                <td><span id="total_deductions" class="display_currency"
                                        data-currency_symbol="true">{{ $total_deductions }}</span></td>
                                <td>&nbsp;</td>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <div class="col-md-12">
                <h4 class="pull-right">@lang('essentials::lang.gross_amount'): <span id="gross_amount_text" class="display_currency"
                        data-currency_symbol="true">{{ $payroll->final_total }}</span></h4>
