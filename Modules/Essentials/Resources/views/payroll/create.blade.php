                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('hrm/payroll') }}">@lang('essentials::lang.payroll')</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>{{ $subtitle }}</span>
                                </li>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::text('payroll_group_name', !empty($payroll_group) ? $payroll_group->name : strip_tags($group_name), [
                                    'class' => 'form-control',
                                    'placeholder' => __('essentials::lang.payroll_group_name'),
                                    'required',
                                ]) !!}
                            </div>
                            <div class="col-md-4">
                                ...
                                {!! Form::select(
                                    ...
                                    ['draft' => __('sale.draft'), 'final' => __('sale.final')],
                                    !empty($payroll_group) ? $payroll_group->status : null,
                                    [
                        ...
                        <table class="table" id="payroll_table">
                            ...
                            @foreach ($payrolls as $employee => $payroll)
                                @php
                                    if ($action != 'edit') {
                                        $amount_per_unit_duration = (float) $payroll['unit_salary'];
                                        ...
                                        $total = (float) $payroll['essentials_salary'];
                                    } else {
                                ...
                                <tr data-id="{{ $employee }}">
                                    ...
                                    <td>
                                        ...
                                        {!! Form::hidden('total_salary_' . $employee, $total, ['id' => 'total_salary_' . $employee]) !!}
                                    ...
                                    <td class="allowance_td">
                                        @component('components.widget')
                                            <table class="table table-condenced allowance_table"
                                                id="allowance_table_{{ $employee }}" data-id="{{ $employee }}">
                                                <thead>
                                                    <tr>
                                                        <th class="col-md-4">@lang('essentials::lang.description')</th>
                                                        <th class="col-md-4">@lang('essentials::lang.amount_type')</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (!empty($payroll['allowances']))
                                                        @foreach ($payroll['allowances']['allowance_names'] as $key => $value)
                                                            ...
                                                            @if (!empty($payroll['allowances']['reimbursement_id'][$key]))
                                                                {!! Form::hidden("payrolls[$employee][reimbursement_ids][]", $payroll['allowances']['reimbursement_id'][$key], [
                                                                    'id' => 'reimbursement_ids',
                                                                ]) !!}
                                                            @endif
                                            ...
                                            <table class="table table-condenced deductions_table"
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (!empty($payroll['deductions']))
                                                        @php echo "teste deduction"; @endphp
