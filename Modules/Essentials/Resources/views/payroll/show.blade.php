                    ...
                    <tr>
                        <td colspan="2" style="width: 50% !important;">
                            ...
                            <div style="width: 30% !important;float: right;">
                                <span class="display_currency" data-currency_symbol="true">
                                    {{ $ytd_payroll['basic']['basic_salary'] }}
                                </span>
                                <br>
                            </div>
                            <div style="width: 20% !important;float: right;">
                                <span class="display_currency" data-currency_symbol="true">
                                    {{ $payroll->essentials_unit_salary }}
                                </span>
                                <br>
                            </div>
                            ...
                            @forelse($allowances['allowance_names'] as $key => $value)
                                ...
                                <div style="width: 30% !important;float: right;">
                                    <span class="display_currency" data-currency_symbol="true">
                                        <?php if (array_key_exists($value, $ytd_payroll['allowance'])) {
                                            echo $ytd_payroll['allowance'][$value];
                                        } ?>
                                    </span>
                                </div>
                                <div style="width: 20% !important;float: right;">
                        ...
                        <td colspan="2" style="width: 50% !important;">
                            ...
                            @forelse($deductions['deduction_names'] as $key => $value)
                                ...
                                <div style="width: 20% !important;float: right;">
                                    <span class="display_currency" data-currency_symbol="true">
                                        <?php if (array_key_exists($value, $ytd_payroll['deduction'])) {
                                            echo $ytd_payroll['deduction'][$value];
                                        } ?>
                                    </span>
                                </div>
                                <div style="width: 30% !important;float: right;">
