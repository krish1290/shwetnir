...
@endpush
@php
    $page_title = __('essentials::lang.add_training');
...
@section('content')
    ...
    <section class="content">
        @component('components.widget')
            <div class="row">
                {!! Form::open([
                    'url' => action([\Modules\Essentials\Http\Controllers\TrainingController::class, 'store']),
                    'method' => 'post',
                    'id' => 'trainingForm',
                ]) !!}
    ...
    @section('javascript')
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                /*let mockFile = [{
                    name: "AUD-20150322-WA0000.3ga",
                    id: "ed107e7c-a306-4eed-bf58-289a4392be85",
                    path: "uploads/training_docs/1683653228_AUD-20150322-WA0000.3ga",
                    dataURL: "http://localhost/olympasllc/public/uploads/training_docs/1683653228_AUD-20150322-WA0000.3ga"
                }];*/
                mockFile = [];
                let deletedFile = [];
                let uploadedFile = [];
                var myDropzone = new Dropzone("div#demo-upload", {
                    ...
                    init: function() {
                        //show existing file
                        for ($i = 0; $i < mockFile.length; $i++) {
                            this.displayExistingFile(mockFile[$i], mockFile[$i].dataURL);
                        ...
                        this.on("removedfile", function(file) {
                            ...
                            if (file?.upload !== undefined) { //delete uploded file
                                ...
                                deletedFile = mockFile.filter((item) => {
                                    return item.id === file.id
                                })[0];
                            }
