...
class EssentialsHolidayController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            ->addColumn(
                'action',
                '@can("essentials.edit_holiday")
                    <button class="btn btn-xs btn-primary btn-modal" data-container="#add_holiday_modal" data-href="{{action(\'Modules\Essentials\Http\Controllers\EssentialsHolidayController@edit\', [$id])}}"><i class="fa fa-edit"></i> '.__('messages.edit').'</button>
                    &nbsp;
                @endcan
                @can("essentials.delete_holiday")
                <button class="btn btn-xs btn-danger delete-holiday" data-href="{{action(\'Modules\Essentials\Http\Controllers\EssentialsHolidayController@destroy\', [$id])}}"><i class="fa fa-trash"></i> '.__('messages.delete').'</button>
                @endcan'
            )
