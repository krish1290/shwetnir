...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu')->group(function () {
    ...
    Route::prefix('hrm')->group(function () {
        ...
        Route::post('/deleteSelected', [Modules\Essentials\Http\Controllers\AttendanceController::class, 'deleteSelected']);
        ...
        Route::get('/send-payroll-email/{id}', [Modules\Essentials\Http\Controllers\PayrollController::class, 'sendPayrollEmail']);
        ...
        Route::get('/payslip/{id}', [Modules\Essentials\Http\Controllers\PayrollController::class, 'generatePayslip']);
        Route::get('/download-payslip/{id}', [Modules\Essentials\Http\Controllers\PayrollController::class, 'downloadPayslip']);
    ...
    Route::resource('/training', 'Modules\Essentials\Http\Controllers\TrainingController');
    Route::post('/training/uploadDocs', [Modules\Essentials\Http\Controllers\TrainingController::class, 'uploadDocs']);
    Route::post('/training/removeDocs', [Modules\Essentials\Http\Controllers\TrainingController::class, 'removeDocs']);

    Route::resource('/claim_reimbursement', 'Modules\Essentials\Http\Controllers\ClaimReimbursementController');
    Route::post('/claim-reimbursement/change-status', [Modules\Essentials\Http\Controllers\ClaimReimbursementController::class, 'changeStatus']);
});
