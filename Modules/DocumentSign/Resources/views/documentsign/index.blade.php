...
@section('title', __('documentsign::lang.documents'))
                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">@lang('documentsign::lang.documents')</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.widget', ['class' => 'box-solid'])
                    @can('documentsign.crud_documents')
                        <div class="table-header">
                            <div class="box-tools">
                                <a class="btn btn-block btn-primary"
                                    href="{{ action([\Modules\DocumentSign\Http\Controllers\DocumentSignController::class, 'create']) }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var training_table = $('#training_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": "{{ action([\Modules\DocumentSign\Http\Controllers\DocumentSignController::class, 'index']) }}"
                },
                columns: [{
                        data: 'title',
                        name: 'title'
