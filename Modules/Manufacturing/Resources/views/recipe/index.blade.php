...
<div class="card bg-white p-6 rounded-xl shadow-xl m-4 p-4" style="box-shadow: 1px 1px 1px 4px #f7f4f4">
    <section class="content-header">
        <h3 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('manufacturing::lang.recipe')</h3>
    </section>
    ...
    <section class="content">
        @component('components.widget', ['class' => 'box-solid'])
            ...
            @slot('tool')
                <div class="box-tools">
                <button class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right btn-modal btn btn-primary m-2"
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="recipe_table">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="8">
                                <button type="button" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error btn btn-primary" id="mass_update_product_price" >@lang('manufacturing::lang.update_product_price')</button> @show_tooltip(__('manufacturing::lang.update_product_price_help'))
                            </td>
                        </tr>
                    </tfoot>
                </table>
