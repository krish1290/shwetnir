<tr>
	...
	<td>
		<div class="input-group">
			{!! Form::text('ingredients[' . $row_index . '][waste_percent]', !empty($ingredient->waste_percent) ? @num_format($ingredient->waste_percent) : 0, ['class' => 'form-control input_number waste_percent input-sm', 'placeholder' => __('manufacturing::lang_v1.waste_percent')]); !!}
