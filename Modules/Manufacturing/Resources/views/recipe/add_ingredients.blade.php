...
<section class="content-header p-3">
    <h3 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black" >@lang('manufacturing::lang.add_ingredients')</h3>
</section>
...
<section class="content">
	...
	<div class="box box-solid">
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
					<button type="button" class="tw-dw-btn tw-dw-btn-success tw-text-white pull-right btn btn-primary" id="add_ingredient_group">@lang('manufacturing::lang.add_ingredient_group') @show_tooltip(__('manufacturing::lang.ingredient_group_tooltip'))</button>
				</div>
	...
	<div class="box box-solid">
		<div class="box-body">
			...
			<div class="row">
				<div class="col-sm-12">
					<button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white pull-right btn btn-primary">@lang('messages.save')</button>
				</div>
			</div>
		</div>
	</div>
